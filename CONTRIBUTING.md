...
1. Open a pull request to [`covidgreen/covid-green-interoperability-service:current`](https://github.com/covidgreen/covid-green-interoperability-service/pulls) that adds your name, username, and email to the team you have choosen in the [README.md](./README.md). The members lists are sorted alphabetically; make sure to add your name in the proper order.
